...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="main script untuk sentiment analisis \
    ...
    if args.export:
        ...
        file_name, i = f'output/{datetime.today().strftime("%Y-%m-%d")} - Jakarta Covid Tweet Sentiment Analysis', 1
